  ...
  factory: (require) => {
    ...
    (function () {
      ...
      var css = [
        ...
        ".fe-md-outline{position:absolute;right:0;top:50%;transform:translateY(-50%);z-index:6;display:flex;flex-direction:column;align-items:flex-end}",
        ...
        ".fe-md-outline-dot{flex:none;width:10px;height:3px;border-radius:2px;background:var(--dsw-alias-label-tertiary,#8b93a5)}",
        ...
        children: [
          jsxs("div", {
            ...
            children: headings.map(function (h) {
              return jsx("span", { className: "fe-md-outline-dot" }, h.id);
            })
          }),
          jsxs("div", {
