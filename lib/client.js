  ...
  factory: (require) => {
    ...
    (function () {
      ...
      var css = [
        ...
        ".fe-md-outline{position:absolute;top:0;right:0;bottom:0;width:14px;overflow:hidden;display:flex;flex-direction:column;background:transparent;border-left:1px solid transparent;transition:width .18s ease,background-color .18s ease,border-color .18s ease;z-index:5}",
        ".fe-md-outline:hover{width:260px;background:var(--dsw-alias-bg-module-platform,#17181c);border-left:1px solid var(--dsw-alias-separator-primary,rgba(255,255,255,.07));box-shadow:-10px 0 28px rgba(0,0,0,.28)}",
        ".fe-md-outline::before{content:\"\";position:absolute;left:3px;top:16px;bottom:16px;width:6px;border-radius:3px;background:var(--dsw-alias-scrollbar-bg-l2,rgba(255,255,255,.08));opacity:1;transition:opacity .12s ease}",
        ".fe-md-outline:hover::before{opacity:0}",
        ".fe-md-outline-title{flex:none;padding:12px 16px 8px;font-size:12px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#c7c9d1);display:none}",
        ".fe-md-outline:hover .fe-md-outline-title{display:block}",
        ".fe-md-outline-list{flex:1;min-height:0;overflow:auto;padding:0 8px 12px;display:none}",
        ".fe-md-outline:hover .fe-md-outline-list{display:block}",
